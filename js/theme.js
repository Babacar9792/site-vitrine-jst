...
const downloadButton = document.getElementById("download"); // Remplacez "votre_bouton_id" par l'ID de votre bouton

// Ajout d'un gestionnaire d'événements au clic du bouton
// downloadButton.addEventListener("click", function() {
//   // Création d'un élément <a> pour le téléchargement
//   const link = document.createElement("a");
//   link.href = "../image_jst/"; // Remplacez "chemin_vers_votre_fichier" par le chemin vers votre fichier
//   link.download = "PrésentationJEEFSoTech (1).pdf"; // Remplacez "nom_du_fichier" par le nom de votre fichier
...
function showSlide(index) {
    ...
    currentSlide = (index + slides.length) % slides.length; // Pour gérer les transitions d'un extrême à l'autre
...
const nextButton = document.getElementById('next');
    ...
    const textContainer = document.querySelectorAll('.text-container-small');
